    ...
    <div className="w-full h-full relative font-poppins">
      ...
      >
        ...
        <div className="w-full flex flex-col items-center space-y-4 lg:hidden px-4 mt-16">
          <Link className="flex flex-col justify-center items-center h-32 rounded-xl bg-center bg-cover bg-no-repeat bg-[url(https://res.cloudinary.com/dksmk66vo/image/upload/v1677279236/1000_Converted_ag7o4f.png)] w-full"
            to="/portal/event/EVNT0024"
          >
            <p
          ...
          <Link className="flex flex-col justify-center items-center h-32 rounded-xl bg-center bg-cover bg-no-repeat bg-[url(https://res.cloudinary.com/dksmk66vo/image/upload/v1677278943/3188668_y0sebf.jpg)] w-full"
            to="/portal/event/EVNT0038"
          >
            <p
              className={`text-3xl uppercase text-white font-bold font-poppins backdrop-blur-sm`}
          ...
          <Link className="flex flex-col justify-center items-center h-32 rounded-xl bg-center bg-cover bg-no-repeat bg-[url(https://res.cloudinary.com/dksmk66vo/image/upload/v1677279699/5714_ebbszf.jpg)] w-full"
            to="/portal/event/EVNT0009"
          >
            <p
              className={`text-3xl uppercase text-white font-bold font-poppins backdrop-blur-sm`}
          ...
          <Link className="flex flex-col justify-center items-center h-32 rounded-xl bg-center bg-cover bg-no-repeat bg-[url(https://res.cloudinary.com/dksmk66vo/image/upload/v1677280222/5807361_zfzvps.jpg)] w-full"
            to="/portal/event/EVNT0023"
          >
            <p
              className={`text-3xl uppercase text-white font-bold font-poppins backdrop-blur-sm`}
          ...
          <Link className="flex flex-col justify-center items-center h-32 rounded-xl bg-center bg-cover bg-no-repeat bg-[url(https://res.cloudinary.com/dksmk66vo/image/upload/v1677280480/5111951_mifnpc.jpg)] w-full"
            to="/portal/event/EVNT0036"
          >
            <p
              className={`text-3xl uppercase text-white font-bold font-poppins backdrop-blur-sm`}
