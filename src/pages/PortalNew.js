...
const NavBar = () => {
  return (
    <nav className="w-1/4 bg-white  h-screen overflow-y-scroll px-6 divide-y divide-gray-600 font-poppins">
      <div className="py-8">
...
const Main = () => {
  return (
    <section className="w-full px-16 font-poppins py-12 h-screen overflow-y-scroll">
      <h1 className="text-3xl text-white font-semibold">Scan and Reckon</h1>
      <h2 className="text-base mt-2 text-gray-400 tracking-widest">Brainiac</h2>
      <p className="text-white mt-8 text-base w-[70%]">
      ...
      <div className="flex flex-col lg:flex-row gap-4 w-full px-4 lg:px-0 my-6">
        ...
        <div className="w-full lg:w-1/3 space-y-4 flex flex-col justify-between">
          ...
          <div className="bg-[#ffffff] flex flex-col rounded-3xl p-8 lg:p-12 space-y-4 justify-center">
            <div className="flex flex-row items-center gap-4 lg:gap-4">
              <p className="text-3xl lg:text-6xl font-semibold tracking-wide text-[#3c4043]">
                24
              </p>
          ...
          <div className="bg-[#ffffff] flex-1 rounded-3xl p-12 space-y-6">
