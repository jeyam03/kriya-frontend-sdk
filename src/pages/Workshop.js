...
const Workshop = () => {
  ...
  return !workshopDetail ? (
    ...
    <section className="w-full lg:px-16 font-poppins py-12 pt-24 lg:pt-12 h-screen overflow-y-scroll">
      <div className="flex w-fit space-x-6 whitespace-nowrap [will-change:transform] animate-marquee py-2 mb-12 text-white bg-gradient-to-r from-[#C80067] to-[#5451B6]">
        <p className="">
