      ...
      <div className="flex flex-col lg:flex-row gap-4 w-full lg:w-3/4">
        <div className="bg-[#e5e5ff] w-full lg:w-2/3 rounded-3xl p-12 space-y-8 relative">
          ...
          <div className="space-y-2 z-30">
            ...
            <p className="text-xl tracking-wide text-justify text-[#3c4043] lg:pl-[5.5rem] pt-4 lg:pt-0">
        ...
        <div className="w-full lg:w-1/3 space-y-4 flex flex-col justify-between">
          <div className="bg-[#000000] rounded-3xl p-12 space-y-4">
            <p className="text-4xl font-semibold tracking-wide text-white">
              Register Here !
            </p>
          </div>

          <div className="bg-[#e5e5ff] flex-1 rounded-3xl p-12 space-y-4">
