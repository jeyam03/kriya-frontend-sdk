...
const RegisterPage2 = ({ switchPage }) => {
  ...
  return (
    <div className="w-full py-8 px-6 lg:py-16 lg:px-8 shadow-xl bg-red-400 space-y-6 mt-96 lg:mt-0">
...
const RegisterPage3 = ({ switchPage }) => {
  ...
  return (
    <div className="w-full py-12 px-6 lg:py-16 lg:px-8 shadow-xl bg-white space-y-12">
      ...
      <h1 className="text-xl font-semibold text-[#181818]">Name : {name}</h1>
      <h1 className="text-xl font-semibold text-[#181818]">Email : {email}</h1>
      <button className="bg-black hover:bg-gray-700 transition-all duration-500 w-full text-white text-lg rounded-lg py-2 px-4">
        Go to site !
      </button>
