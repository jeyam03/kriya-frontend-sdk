...
const EventGrid = ({
  ...
  return (
    <div className="group relative transition-all hover:z-30 font-poppins w-[21rem]">
      <div className="absolute group-hover:shadow-lg opacity-0 -translate-y-20 group-hover:-translate-y-2 group-hover:opacity-100 left-0 top-[100%] w-full group-hover:scale-[110%] bg-gray-200 rounded-b-3xl px-4 pt-2 transition-all ease-in-out">
      ...
      <div
        className={`${className} group-hover:shadow-lg z-20 text-lg text-blue rounded-3xl h-full relative bg-gray-200 group-hover:scale-[110%] transition-all`}
        style={{
      ...
      >
        <button
          onClick={() => navigate(to)}
          className={`${arrowColor} rounded-bl-3xl p-2  absolute top-0 right-0 z-20`}
        >
        ...
        <div className=" p-6 pt-3 rounded-b-3xl backdrop-blur-md group-hover:backdrop-blur-none transition-all text-gray-200">
