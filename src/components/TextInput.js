...
const Inputfield = ({
  ...
  return (
    ...
    >
      <label className="text-blue text-sm">{title}</label>
      <div className="flex space-x-2 items-center w-full">
        <input
          ...
          className={` px-4 py-2 rounded-sm w-full text-slate bg-gray bg-clip-padding bg-no-repeat border-2 border-solid ${
